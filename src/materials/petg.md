...
| Outdoor use | Can work for some outdoor parts, but long-term UV exposure favours **[ASA]({{ '/materials/asa/' | url }})** |
...
| Great alternatives | **[ASA]({{ '/materials/asa/' | url }})** for outdoor UV · **[ABS]({{ '/materials/abs/' | url }})** for higher heat · **[Nylon]({{ '/materials/nylon/' | url }})** for wear/fatigue |
...
### Not “ultra rigid”
PETG can be slightly more flexible than ABS/ASA depending on geometry. That’s not a downside — it often improves impact behaviour — but if you need maximum stiffness, a composite material can help (see **[Carbon‑fibre composites]({{ '/materials/carbon-fibre-composites/' | url }})**).
