...
| Great alternatives | **[PETG]({{ '/materials/petg/' | url }})** for simpler functional prints · **[ABS]({{ '/materials/abs/' | url }})** for indoor heat parts |
...
Large thin flats can warp in any material. If your part is a big panel, splitting and adding alignment features can improve reliability (see **[3D Design & File Support]({{ '/services/design-support/' | url }})**).
