...
| Outdoor use | Not ideal for long-term UV exposure — consider **[ASA]({{ '/materials/asa/' | url }})** |
...
### 2) Dimensional fit
ABS can produce accurate parts, but shrink behaviour means tight-fit interfaces may need test iterations. If your project has critical fits, we can iterate with measurements until it’s correct (see **[3D Design & File Support]({{ '/services/design-support/' | url }})**).
...
See:
- **[ASA]({{ '/materials/asa/' | url }})**
- **[PETG]({{ '/materials/petg/' | url }})**
